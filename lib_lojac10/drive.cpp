...
void set_drive_pow(int l, int r) {
  lfMotor.spin(fwd, l * SCALE, voltageUnits::mV);
  lbMotor.spin(fwd, l * SCALE, voltageUnits::mV);
  rfMotor.spin(fwd, r * SCALE, voltageUnits::mV);
  rbMotor.spin(fwd, r * SCALE, voltageUnits::mV);
}
